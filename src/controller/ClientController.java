...
public class ClientController extends Thread {
            ...
            while (true) {
                ...
                if (firstChars.equalsIgnoreCase("img")) {
                    ...
                    if (!cmd.equalsIgnoreCase(lblname.getText())) {
                        ...
                        clientTextBox.setAlignment(Pos.TOP_LEFT);
                    ...
                    Platform.runLater(() -> clientTextBox.getChildren().addAll(hBox));
    ...
    public void send(){
        String msg = txtText.getText();
        writer.println(lblname.getText() + ": " + txtText.getText());
